The xk6-browser module has been upgraded to work with `v0.9.0` 🎉! This upgrade includes:
...
### Web Vitals are now natively supported by the xk6-browser module [xk6-browser#836](https://github.com/grafana/xk6-browser/pull/836)
