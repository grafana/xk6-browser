...
// TODO: Get rid of this entirely? We only need a Session ID to Target ID map.
type Session struct {
	BaseEventEmitter
...
func NewSession(
	ctx context.Context, id string, tid target.ID, logger *log.Logger,
) *Session {
	s := Session{
...
// TODO: Implement this as part of cdp.Client?
