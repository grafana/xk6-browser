...
func TestLocator(t *testing.T) {
	...
	tests := []struct {
		name string
		do   func(*testBrowser, *browser.Page)
	}{
		{
			"Check", func(tb *testBrowser, p *browser.Page) {
		...
		{
			"Click", func(tb *testBrowser, p *browser.Page) {
		...
		{
			"DblClick", func(tb *testBrowser, p *browser.Page) {
		...
		{
			"DispatchEvent", func(tb *testBrowser, p *browser.Page) {
				result := func() bool {
					v := p.Evaluate(tb.toGojaValue(`() => window.result`))
					return tb.asGojaBool(v)
				}
		...
		{
			"Fill", func(tb *testBrowser, p *browser.Page) {
		...
		{
			"Focus", func(tb *testBrowser, p *browser.Page) {
				focused := func() bool {
		...
		{
			"GetAttribute", func(tb *testBrowser, p *browser.Page) {
				l := p.Locator("#inputText", nil)
		...
		{
			"Hover", func(tb *testBrowser, p *browser.Page) {
				result := func() bool {
					v := p.Evaluate(tb.toGojaValue(`() => window.result`))
					return tb.asGojaBool(v)
				}
		...
		{
			"InnerHTML", func(tb *testBrowser, p *browser.Page) {
				require.Equal(t, `<span>hello</span>`, p.Locator("#divHello", nil).InnerHTML(nil))
			},
		},
		{
			"InnerText", func(tb *testBrowser, p *browser.Page) {
				require.Equal(t, `hello`, p.Locator("#divHello > span", nil).InnerText(nil))
			},
		},
		{
			"InputValue", func(tb *testBrowser, p *browser.Page) {
		...
		{
			"Tap", func(tb *testBrowser, p *browser.Page) {
				result := func() bool {
					v := p.Evaluate(tb.toGojaValue(`() => window.result`))
					return tb.asGojaBool(v)
				}
		...
		{
			"WaitFor state:hidden", func(tb *testBrowser, p *browser.Page) {
				opts := tb.toGojaValue(jsFrameWaitForSelectorOpts{
					jsFrameBaseOpts: jsFrameBaseOpts{Timeout: "100"},
					State:           "hidden",
				})
		...
		{
			"WaitFor state:detached", func(tb *testBrowser, p *browser.Page) {
				opts := tb.toGojaValue(jsFrameWaitForSelectorOpts{
					jsFrameBaseOpts: jsFrameBaseOpts{Timeout: "100"},
					State:           "detached",
				})
	...
	sanityTests := []struct {
		name string
		do   func(*browser.Locator, *testBrowser)
	}{
		{
			"Check", func(l *browser.Locator, tb *testBrowser) { l.Check(timeout(tb)) },
		},
		{
			"Click", func(l *browser.Locator, tb *testBrowser) {
		...
		{
			"Dblclick", func(l *browser.Locator, tb *testBrowser) { l.Dblclick(timeout(tb)) },
		},
		{
			"DispatchEvent", func(l *browser.Locator, tb *testBrowser) {
				l.DispatchEvent("click", tb.toGojaValue("mouseevent"), timeout(tb))
			},
		},
		{
			"Focus", func(l *browser.Locator, tb *testBrowser) { l.Focus(timeout(tb)) },
		},
		{
			"Fill", func(l *browser.Locator, tb *testBrowser) { l.Fill("fill me up", timeout(tb)) },
		},
		{
			"GetAttribute", func(l *browser.Locator, tb *testBrowser) { l.GetAttribute("value", timeout(tb)) },
		},
		{
			"Hover", func(l *browser.Locator, tb *testBrowser) { l.Hover(timeout(tb)) },
		},
		{
			"InnerHTML", func(l *browser.Locator, tb *testBrowser) { l.InnerHTML(timeout(tb)) },
		},
		{
			"InnerText", func(l *browser.Locator, tb *testBrowser) { l.InnerText(timeout(tb)) },
		},
		{
			"InputValue", func(l *browser.Locator, tb *testBrowser) { l.InputValue(timeout(tb)) },
		},
		{
			"Press", func(l *browser.Locator, tb *testBrowser) { l.Press("a", timeout(tb)) },
		},
		{
			"SelectOption", func(l *browser.Locator, tb *testBrowser) { l.SelectOption(tb.toGojaValue(""), timeout(tb)) },
		},
		{
			"Tap", func(l *browser.Locator, tb *testBrowser) { l.Tap(timeout(tb)) },
		},
		{
			"Type", func(l *browser.Locator, tb *testBrowser) { l.Type("a", timeout(tb)) },
		},
		{
			"TextContent", func(l *browser.Locator, tb *testBrowser) { l.TextContent(timeout(tb)) },
		},
		{
			"Uncheck", func(l *browser.Locator, tb *testBrowser) { l.Uncheck(timeout(tb)) },
		},
		{
			"WaitFor", func(l *browser.Locator, tb *testBrowser) { l.WaitFor(timeout(tb)) },
		},
	}
...
func TestLocatorElementState(t *testing.T) {
	...
	tests := []struct {
		state, eval string
		query       func(*browser.Locator) bool
	}{
		{
			"disabled",
			`() => document.getElementById('inputText').disabled = true`,
			func(l *browser.Locator) bool { return !l.IsDisabled(nil) },
		},
		{
			"enabled",
			`() => document.getElementById('inputText').disabled = true`,
			func(l *browser.Locator) bool { return l.IsEnabled(nil) },
		},
		{
			"hidden",
			`() => document.getElementById('inputText').style.visibility = 'hidden'`,
			func(l *browser.Locator) bool { resp, _ := l.IsHidden(); return !resp },
		},
		{
			"readOnly",
			`() => document.getElementById('inputText').readOnly = true`,
			func(l *browser.Locator) bool { return l.IsEditable(nil) },
		},
		{
			"visible",
			`() => document.getElementById('inputText').style.visibility = 'hidden'`,
			func(l *browser.Locator) bool { resp, _ := l.IsVisible(); return resp },
		},
	}
	...
	sanityTests := []struct {
		...
		{
			"IsChecked", func(l *browser.Locator, tb *testBrowser) { l.IsChecked(timeout(tb)) },
		},
		{
			"IsEditable", func(l *browser.Locator, tb *testBrowser) { l.IsEditable(timeout(tb)) },
		},
		{
			"IsEnabled", func(l *browser.Locator, tb *testBrowser) { l.IsEnabled(timeout(tb)) },
		},
		{
			"IsDisabled", func(l *browser.Locator, tb *testBrowser) { l.IsDisabled(timeout(tb)) },
		},
	}
	for _, tt := range sanityTests {
		tt := tt
