...
//
// ===== AFTER =====
// TODO: Should we make this error:strictmodeviolation friendlier?
// ERRO[0001] click: error:strictmodeviolation
//         at reflect.methodValueCall (native)
...
// ... or ...
//
// ERRO[0004] error waiting for selector: element handle cannot evaluate: cannot call function on expression ("\n\t\t(node, injected, selector, strict, state, timeout, ...args) => {\n\t\t\treturn injected.waitForSelector(selector, node, strict, state, 'raf', timeout, ...args);\n\t\t}\n\t\n//# sourceURL=__xk6_browser_evaluation_script__\n") in execution context (5) in frame (4CBD463ACA57362037F4E34B6367847C) with session (C034230EDD59875FB07D39F8A150AD71): exception "Uncaught (in promise)" (0:0): timed out after 0ms
//         at reflect.methodValueCall (native)
//         at pageWaitForSelector (file:///home/ivan/Projects/grafana/xk6-browser/examples/304-log-errors.js:132:29(70))
//         at native  executor=shared-iterations scenario=err source=stacktrace
//
